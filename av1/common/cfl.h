...
static const int cfl_alpha_mags[CFL_ALPHABET_SIZE + 9] = {
...
static const int cfl_alpha_idx[CFL_PRED_PLANES][CFL_ALPHABET_SIZE][CFL_ALPHABET_SIZE] = {
...
static INLINE double cfl_idx_to_alpha(int cfl_uvec_idx, int cfl_mag_idx,
  ...
  const int component = cfl_alpha_idx[pred_type][cfl_uvec_idx][cfl_mag_idx];
  return cfl_alpha_mags[component] * (1. / (1 << 15));
}
