...
#define OD_FDST_4(q0, q1, q2, q3) \
  /* 9 "muls", 13 adds, 2 shifts */ \
  do { \
    /* (1/Sqrt[2] + Sin[Pi/16])/Cos[Pi/16] = 0.919872189386605920700689770 */ \
    q0 -= (q3*15071 + 8192) >> 14; \
    /* Sqrt[2]*Cos[Pi/16] = 1.3870398453221474618216191915664 */ \
    q3 += (q0*22725 + 8192) >> 14; \
    /* (1/Sqrt[2] - Sin[Pi/16]/2)/Cos[Pi/16] = 0.8204160056967769172448907 */ \
    q0 -= (q3*26883 + 16384) >> 15; \
    /* -(1/Sqrt[2] - Cos[3*Pi/16])/Sin[3*Pi/16] = 0.2238471820140128666071 */ \
    q1 += (q2*7735 + 16384) >> 15; \
    /* Sqrt[2]*Sin[3*Pi/16] = 0.78569495838710218127789736765722 */ \
    q2 += (q1*12873 + 8192) >> 14; \
    /* (1/Sqrt[2] - Cos[3*Pi/16]/2)/Sin[3*Pi/16] = 0.524455699240089429053 */ \
    q1 -= (q2*17185 + 16384) >> 15; \
    q1 += OD_DCT_RSHIFT(q3, 1); \
    q3 -= q1; \
    q0 = OD_DCT_RSHIFT(q2, 1) - q0; \
    q2 -= q0; \
    /* Tan[Pi/8] = 0.41421356237309504880168872420970 */ \
    q1 -= (q2*13573 + 16384) >> 15; \
    /* Sin[Pi/4] = 0.70710678118654752440084436210485 */ \
    q2 += (q1*11585 + 8192) >> 14; \
    /* Tan[Pi/8] = 0.41421356237309504880168872420970 */ \
    q1 -= (q2*13573 + 16384) >> 15; \
  } \
