...
static const double OD_TYPEVII_DST8_BASIS[8][8] = {
  {
    0.089131608307533374179595525876744, 0.25535710732537626638604945445794,
    0.38709521401634855375383114491813,  0.46655396708578528375343925032134,
    0.48300202163550873123560630003382,  0.43421797675676216271275153589471,
    0.32679038803214479684281612223280,  0.17522794659573498257179159207151
  },
  {
    0.17522794659573498257179159207151,  0.43421797675676216271275153589471,
    0.46655396708578528375343925032134,  0.25535710732537626638604945445794,
   -0.089131608307533374179595525876744,-0.38709521401634855375383114491813,
   -0.48300202163550873123560630003382, -0.32679038803214479684281612223280
  },
  {
    0.25535710732537626638604945445794,  0.48300202163550873123560630003382,
    0.17522794659573498257179159207151, -0.32679038803214479684281612223280,
   -0.46655396708578528375343925032134, -0.089131608307533374179595525876744,
    0.38709521401634855375383114491813,  0.43421797675676216271275153589471
  },
  {
    0.32679038803214479684281612223280,  0.38709521401634855375383114491813,
   -0.25535710732537626638604945445794, -0.43421797675676216271275153589471,
    0.17522794659573498257179159207151,  0.46655396708578528375343925032134,
   -0.089131608307533374179595525876744,-0.48300202163550873123560630003382
  },
  {
    0.38709521401634855375383114491813,  0.17522794659573498257179159207151,
   -0.48300202163550873123560630003382,  0.089131608307533374179595525876744,
    0.43421797675676216271275153589471, -0.32679038803214479684281612223280,
   -0.25535710732537626638604945445794,  0.46655396708578528375343925032134
  },
  {
    0.43421797675676216271275153589471, -0.089131608307533374179595525876744,
   -0.32679038803214479684281612223280,  0.48300202163550873123560630003382,
   -0.25535710732537626638604945445794, -0.17522794659573498257179159207151,
    0.46655396708578528375343925032134, -0.38709521401634855375383114491813
  },
  {
    0.46655396708578528375343925032134, -0.32679038803214479684281612223280,
    0.089131608307533374179595525876744, 0.17522794659573498257179159207151,
   -0.38709521401634855375383114491813,  0.48300202163550873123560630003382,
   -0.43421797675676216271275153589471,  0.25535710732537626638604945445794
  },
  {
    0.48300202163550873123560630003382, -0.46655396708578528375343925032134,
    0.43421797675676216271275153589471, -0.38709521401634855375383114491813,
    0.32679038803214479684281612223280, -0.25535710732537626638604945445794,
...
void od_bin_fdst8(od_coeff y[8], const od_coeff *x, int xstride) {
  ...
  for (j = 0; j < 8; j++) {
    double t = 0;
    for (i = 0; i < 8; i++) {
      t += OD_TYPEVII_DST8_BASIS[i][j]*x[i*xstride];
    }
    y[j] = (od_coeff)(t + 0.5);
  }
}
...
void od_bin_idst8(od_coeff *x, int xstride, const od_coeff y[8]) {
  ...
  for (j = 0; j < 8; j++) {
    double t = 0;
    for (i = 0; i < 8; i++) {
      t += OD_TYPEVII_DST8_BASIS[j][i]*y[i];
    }
    x[j*xstride] = (od_coeff)(t + 0.5);
  }
}
