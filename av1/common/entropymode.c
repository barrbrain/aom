...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18581), AOM_ICDF(20101), AOM_ICDF(21275), AOM_ICDF(21501),
  AOM_ICDF(21589), AOM_ICDF(26899), AOM_ICDF(28117), AOM_ICDF(28204),
  AOM_ICDF(28300), AOM_ICDF(28561), AOM_ICDF(29096), AOM_ICDF(30906),
  AOM_ICDF(31268), AOM_ICDF(32229), AOM_ICDF(32546), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(694),   AOM_ICDF(2600),  AOM_ICDF(2958),  AOM_ICDF(4112),
  AOM_ICDF(5862),  AOM_ICDF(8522),  AOM_ICDF(9363),  AOM_ICDF(15303),
  AOM_ICDF(16472), AOM_ICDF(22658), AOM_ICDF(23697), AOM_ICDF(28205),
  AOM_ICDF(28871), AOM_ICDF(31004), AOM_ICDF(31918), AOM_ICDF(32768)
};
#endif
