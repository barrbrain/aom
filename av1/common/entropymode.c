...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21075), AOM_ICDF(24217), AOM_ICDF(25704), AOM_ICDF(26919),
  AOM_ICDF(28033), AOM_ICDF(29270), AOM_ICDF(29814), AOM_ICDF(30426),
  AOM_ICDF(30997), AOM_ICDF(31375), AOM_ICDF(31407), AOM_ICDF(31806),
  AOM_ICDF(32080), AOM_ICDF(32543), AOM_ICDF(32667), AOM_ICDF(32768)
};
#endif
