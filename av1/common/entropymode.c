...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21011), AOM_ICDF(24357), AOM_ICDF(25927), AOM_ICDF(27364),
  AOM_ICDF(28400), AOM_ICDF(29298), AOM_ICDF(29909), AOM_ICDF(30440),
  AOM_ICDF(30956), AOM_ICDF(31346), AOM_ICDF(31705), AOM_ICDF(32042),
  AOM_ICDF(32309), AOM_ICDF(32543), AOM_ICDF(32668), AOM_ICDF(32768)
};
#endif
