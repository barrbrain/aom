...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(20519), AOM_ICDF(24053), AOM_ICDF(25637), AOM_ICDF(27208),
  AOM_ICDF(28274), AOM_ICDF(29150), AOM_ICDF(29805), AOM_ICDF(30354),
  AOM_ICDF(30866), AOM_ICDF(31292), AOM_ICDF(31700), AOM_ICDF(32047),
  AOM_ICDF(32318), AOM_ICDF(32535), AOM_ICDF(32664), AOM_ICDF(32768)
};
#endif
