...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18531), AOM_ICDF(19908), AOM_ICDF(21036), AOM_ICDF(21267),
  AOM_ICDF(21353), AOM_ICDF(26608), AOM_ICDF(28034), AOM_ICDF(28120),
  AOM_ICDF(28212), AOM_ICDF(28462), AOM_ICDF(28979), AOM_ICDF(30906),
  AOM_ICDF(31268), AOM_ICDF(32301), AOM_ICDF(32530), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(669),   AOM_ICDF(2634),  AOM_ICDF(2993),  AOM_ICDF(4185),
  AOM_ICDF(5928),  AOM_ICDF(8100),  AOM_ICDF(8939),  AOM_ICDF(15249),
  AOM_ICDF(16412), AOM_ICDF(22967), AOM_ICDF(24005), AOM_ICDF(28100),
  AOM_ICDF(28778), AOM_ICDF(31102), AOM_ICDF(32008), AOM_ICDF(32768)
};
#endif
