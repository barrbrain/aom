...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18514), AOM_ICDF(20142), AOM_ICDF(21339), AOM_ICDF(21550),
  AOM_ICDF(21634), AOM_ICDF(27035), AOM_ICDF(28228), AOM_ICDF(28349),
  AOM_ICDF(28440), AOM_ICDF(28697), AOM_ICDF(29263), AOM_ICDF(30927),
  AOM_ICDF(31320), AOM_ICDF(32155), AOM_ICDF(32494), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(696),   AOM_ICDF(2510),  AOM_ICDF(2955),  AOM_ICDF(4158),
  AOM_ICDF(6004),  AOM_ICDF(8782),  AOM_ICDF(9693),  AOM_ICDF(15309),
  AOM_ICDF(16467), AOM_ICDF(22488), AOM_ICDF(23490), AOM_ICDF(28042),
  AOM_ICDF(28707), AOM_ICDF(30817), AOM_ICDF(31787), AOM_ICDF(32768)
};
#endif
