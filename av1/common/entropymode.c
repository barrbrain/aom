...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21008), AOM_ICDF(24294), AOM_ICDF(25854), AOM_ICDF(26804),
  AOM_ICDF(27846), AOM_ICDF(29279), AOM_ICDF(29810), AOM_ICDF(30421),
  AOM_ICDF(30890), AOM_ICDF(31254), AOM_ICDF(31453), AOM_ICDF(31851),
  AOM_ICDF(32125), AOM_ICDF(32543), AOM_ICDF(32667), AOM_ICDF(32768)
};
#endif
