...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(20488), AOM_ICDF(24090), AOM_ICDF(25672), AOM_ICDF(27237),
  AOM_ICDF(28282), AOM_ICDF(29150), AOM_ICDF(29806), AOM_ICDF(30350),
  AOM_ICDF(30865), AOM_ICDF(31295), AOM_ICDF(31702), AOM_ICDF(32046),
  AOM_ICDF(32318), AOM_ICDF(32535), AOM_ICDF(32663), AOM_ICDF(32768)
};
#endif
