...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21039), AOM_ICDF(24291), AOM_ICDF(25845), AOM_ICDF(26898),
  AOM_ICDF(27972), AOM_ICDF(29317), AOM_ICDF(29847), AOM_ICDF(30462),
  AOM_ICDF(30943), AOM_ICDF(31313), AOM_ICDF(31345), AOM_ICDF(31742),
  AOM_ICDF(32018), AOM_ICDF(32545), AOM_ICDF(32669), AOM_ICDF(32768)
};
#endif
