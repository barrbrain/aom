...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_ICDF(1468),  AOM_ICDF(4378),  AOM_ICDF(9584),  AOM_ICDF(14123),
  AOM_ICDF(25066), AOM_ICDF(26586), AOM_ICDF(32278), AOM_ICDF(32768)
};
...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES]
      ...
      { { 0 },
        { AOM_ICDF(12818), AOM_ICDF(22234), AOM_ICDF(26750), AOM_ICDF(29544),
          AOM_ICDF(30980), AOM_ICDF(31595), AOM_ICDF(31915), AOM_ICDF(32265),
          AOM_ICDF(32380), AOM_ICDF(32554), AOM_ICDF(32674), AOM_ICDF(32705),
          AOM_ICDF(32741), AOM_ICDF(32751), AOM_ICDF(32758), AOM_ICDF(32768) } },
      { { 0 },
        { AOM_ICDF(19133), AOM_ICDF(26507), AOM_ICDF(29397), AOM_ICDF(30905),
          AOM_ICDF(31678), AOM_ICDF(31986), AOM_ICDF(32166), AOM_ICDF(32408),
          AOM_ICDF(32469), AOM_ICDF(32551), AOM_ICDF(32621), AOM_ICDF(32641),
          AOM_ICDF(32676), AOM_ICDF(32684), AOM_ICDF(32695), AOM_ICDF(32768) } },
      { { AOM_ICDF(8637),  AOM_ICDF(17335), AOM_ICDF(22744), AOM_ICDF(27668),
          AOM_ICDF(30451), AOM_ICDF(31678), AOM_ICDF(32254), AOM_ICDF(32632),
          AOM_ICDF(32709), AOM_ICDF(32743), AOM_ICDF(32759), AOM_ICDF(32762),
          AOM_ICDF(32765), AOM_ICDF(32766), AOM_ICDF(32767), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(7017),  AOM_ICDF(13105), AOM_ICDF(18147), AOM_ICDF(22825),
          AOM_ICDF(26440), AOM_ICDF(29015), AOM_ICDF(30569), AOM_ICDF(31946),
          AOM_ICDF(32341), AOM_ICDF(32535), AOM_ICDF(32608), AOM_ICDF(32650),
          AOM_ICDF(32663), AOM_ICDF(32676), AOM_ICDF(32687), AOM_ICDF(32768) },
        { AOM_ICDF(15738), AOM_ICDF(23896), AOM_ICDF(27524), AOM_ICDF(29413),
          AOM_ICDF(30453), AOM_ICDF(31046), AOM_ICDF(31469), AOM_ICDF(31959),
          AOM_ICDF(32177), AOM_ICDF(32408), AOM_ICDF(32555), AOM_ICDF(32633),
          AOM_ICDF(32667), AOM_ICDF(32682), AOM_ICDF(32701), AOM_ICDF(32768) } },
      { { AOM_ICDF(3909),  AOM_ICDF(11765), AOM_ICDF(18443), AOM_ICDF(23622),
          AOM_ICDF(26968), AOM_ICDF(28962), AOM_ICDF(30304), AOM_ICDF(31673),
          AOM_ICDF(32187), AOM_ICDF(32422), AOM_ICDF(32532), AOM_ICDF(32603),
          AOM_ICDF(32636), AOM_ICDF(32659), AOM_ICDF(32685), AOM_ICDF(32768) },
        { AOM_ICDF(10641), AOM_ICDF(19782), AOM_ICDF(24680), AOM_ICDF(27639),
          AOM_ICDF(29327), AOM_ICDF(30282), AOM_ICDF(30886), AOM_ICDF(31547),
          AOM_ICDF(31818), AOM_ICDF(32072), AOM_ICDF(32233), AOM_ICDF(32348),
          AOM_ICDF(32413), AOM_ICDF(32463), AOM_ICDF(32521), AOM_ICDF(32768) } },
      { { AOM_ICDF(11476), AOM_ICDF(21079), AOM_ICDF(25808), AOM_ICDF(29254),
          AOM_ICDF(31072), AOM_ICDF(31842), AOM_ICDF(32202), AOM_ICDF(32530),
          AOM_ICDF(32591), AOM_ICDF(32650), AOM_ICDF(32693), AOM_ICDF(32709),
          AOM_ICDF(32740), AOM_ICDF(32749), AOM_ICDF(32754), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(7932),  AOM_ICDF(17302), AOM_ICDF(23283), AOM_ICDF(26814),
          AOM_ICDF(28860), AOM_ICDF(30055), AOM_ICDF(30800), AOM_ICDF(31597),
          AOM_ICDF(31911), AOM_ICDF(32108), AOM_ICDF(32240), AOM_ICDF(32349),
          AOM_ICDF(32408), AOM_ICDF(32463), AOM_ICDF(32526), AOM_ICDF(32768) },
        { AOM_ICDF(7371),  AOM_ICDF(16018), AOM_ICDF(21564), AOM_ICDF(25543),
          AOM_ICDF(27812), AOM_ICDF(29097), AOM_ICDF(30033), AOM_ICDF(31094),
          AOM_ICDF(31598), AOM_ICDF(32102), AOM_ICDF(32363), AOM_ICDF(32505),
          AOM_ICDF(32563), AOM_ICDF(32597), AOM_ICDF(32637), AOM_ICDF(32768) } },
      { { AOM_ICDF(7340),  AOM_ICDF(15346), AOM_ICDF(20834), AOM_ICDF(24925),
          AOM_ICDF(27534), AOM_ICDF(29147), AOM_ICDF(30193), AOM_ICDF(31175),
          AOM_ICDF(31597), AOM_ICDF(31884), AOM_ICDF(32069), AOM_ICDF(32210),
          AOM_ICDF(32288), AOM_ICDF(32355), AOM_ICDF(32436), AOM_ICDF(32768) },
        { AOM_ICDF(14688), AOM_ICDF(23115), AOM_ICDF(26811), AOM_ICDF(28814),
          AOM_ICDF(30016), AOM_ICDF(30639), AOM_ICDF(31097), AOM_ICDF(31590),
          AOM_ICDF(31810), AOM_ICDF(32055), AOM_ICDF(32216), AOM_ICDF(32334),
          AOM_ICDF(32419), AOM_ICDF(32467), AOM_ICDF(32523), AOM_ICDF(32768) } },
    };
#endif
