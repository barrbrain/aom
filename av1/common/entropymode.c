...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES]
      ...
      { { 0 },
        { AOM_ICDF(12782), AOM_ICDF(23102), AOM_ICDF(27789), AOM_ICDF(30350),
          AOM_ICDF(31366), AOM_ICDF(31894), AOM_ICDF(32167), AOM_ICDF(32397),
          AOM_ICDF(32485), AOM_ICDF(32636), AOM_ICDF(32716), AOM_ICDF(32741),
          AOM_ICDF(32759), AOM_ICDF(32763), AOM_ICDF(32765), AOM_ICDF(32768) } },
      { { 0 },
        { AOM_ICDF(23425), AOM_ICDF(28835), AOM_ICDF(30569), AOM_ICDF(31541),
          AOM_ICDF(32022), AOM_ICDF(32175), AOM_ICDF(32243), AOM_ICDF(32447),
          AOM_ICDF(32463), AOM_ICDF(32513), AOM_ICDF(32564), AOM_ICDF(32573),
          AOM_ICDF(32599), AOM_ICDF(32602), AOM_ICDF(32607), AOM_ICDF(32768) } },
      { { AOM_ICDF(6622),  AOM_ICDF(15280), AOM_ICDF(21040), AOM_ICDF(27163),
          AOM_ICDF(30695), AOM_ICDF(31918), AOM_ICDF(32439), AOM_ICDF(32698),
          AOM_ICDF(32742), AOM_ICDF(32759), AOM_ICDF(32766), AOM_ICDF(32766),
          AOM_ICDF(32767), AOM_ICDF(32768), AOM_ICDF(32768), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(5964),  AOM_ICDF(11379), AOM_ICDF(16579), AOM_ICDF(21617),
          AOM_ICDF(25737), AOM_ICDF(28798), AOM_ICDF(30646), AOM_ICDF(32149),
          AOM_ICDF(32501), AOM_ICDF(32651), AOM_ICDF(32697), AOM_ICDF(32721),
          AOM_ICDF(32728), AOM_ICDF(32732), AOM_ICDF(32737), AOM_ICDF(32768) },
        { AOM_ICDF(15436), AOM_ICDF(24006), AOM_ICDF(27495), AOM_ICDF(29418),
          AOM_ICDF(30480), AOM_ICDF(31064), AOM_ICDF(31462), AOM_ICDF(31986),
          AOM_ICDF(32177), AOM_ICDF(32447), AOM_ICDF(32595), AOM_ICDF(32666),
          AOM_ICDF(32694), AOM_ICDF(32709), AOM_ICDF(32719), AOM_ICDF(32768) } },
      { { AOM_ICDF(2566),  AOM_ICDF(10446), AOM_ICDF(17396), AOM_ICDF(22938),
          AOM_ICDF(26493), AOM_ICDF(28646), AOM_ICDF(29967), AOM_ICDF(31700),
          AOM_ICDF(32231), AOM_ICDF(32449), AOM_ICDF(32552), AOM_ICDF(32610),
          AOM_ICDF(32640), AOM_ICDF(32658), AOM_ICDF(32679), AOM_ICDF(32768) },
        { AOM_ICDF(10732), AOM_ICDF(20255), AOM_ICDF(24810), AOM_ICDF(27774),
          AOM_ICDF(29404), AOM_ICDF(30281), AOM_ICDF(30837), AOM_ICDF(31562),
          AOM_ICDF(31787), AOM_ICDF(32001), AOM_ICDF(32148), AOM_ICDF(32269),
          AOM_ICDF(32332), AOM_ICDF(32382), AOM_ICDF(32436), AOM_ICDF(32768) } },
      { { AOM_ICDF(12487), AOM_ICDF(23279), AOM_ICDF(27456), AOM_ICDF(30338),
          AOM_ICDF(31715), AOM_ICDF(32182), AOM_ICDF(32398), AOM_ICDF(32644),
          AOM_ICDF(32673), AOM_ICDF(32702), AOM_ICDF(32729), AOM_ICDF(32734),
          AOM_ICDF(32761), AOM_ICDF(32764), AOM_ICDF(32765), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(9357),  AOM_ICDF(18699), AOM_ICDF(24058), AOM_ICDF(27370),
          AOM_ICDF(29137), AOM_ICDF(30173), AOM_ICDF(30802), AOM_ICDF(31571),
          AOM_ICDF(31829), AOM_ICDF(32027), AOM_ICDF(32162), AOM_ICDF(32286),
          AOM_ICDF(32349), AOM_ICDF(32397), AOM_ICDF(32463), AOM_ICDF(32768) },
        { AOM_ICDF(6105),  AOM_ICDF(14871), AOM_ICDF(20906), AOM_ICDF(25151),
          AOM_ICDF(27507), AOM_ICDF(28807), AOM_ICDF(29699), AOM_ICDF(30957),
          AOM_ICDF(31494), AOM_ICDF(32115), AOM_ICDF(32401), AOM_ICDF(32533),
          AOM_ICDF(32579), AOM_ICDF(32608), AOM_ICDF(32637), AOM_ICDF(32768) } },
      { { AOM_ICDF(6921),  AOM_ICDF(15472), AOM_ICDF(20797), AOM_ICDF(24494),
          AOM_ICDF(26789), AOM_ICDF(28216), AOM_ICDF(29193), AOM_ICDF(30231),
          AOM_ICDF(30693), AOM_ICDF(31112), AOM_ICDF(31340), AOM_ICDF(31552),
          AOM_ICDF(31639), AOM_ICDF(31714), AOM_ICDF(31835), AOM_ICDF(32768) },
        { AOM_ICDF(15064), AOM_ICDF(23305), AOM_ICDF(26679), AOM_ICDF(28588),
          AOM_ICDF(29806), AOM_ICDF(30453), AOM_ICDF(30921), AOM_ICDF(31434),
          AOM_ICDF(31642), AOM_ICDF(31884), AOM_ICDF(32037), AOM_ICDF(32176),
          AOM_ICDF(32253), AOM_ICDF(32307), AOM_ICDF(32373), AOM_ICDF(32768) } },
    };
#endif
