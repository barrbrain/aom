...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21488), AOM_ICDF(24472), AOM_ICDF(25863), AOM_ICDF(27153),
  AOM_ICDF(28252), AOM_ICDF(29402), AOM_ICDF(29904), AOM_ICDF(30490),
  AOM_ICDF(31082), AOM_ICDF(31428), AOM_ICDF(31463), AOM_ICDF(31841),
  AOM_ICDF(32147), AOM_ICDF(32520), AOM_ICDF(32661), AOM_ICDF(32768)
};
#endif
