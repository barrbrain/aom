...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21022), AOM_ICDF(24369), AOM_ICDF(25929), AOM_ICDF(26821),
  AOM_ICDF(27854), AOM_ICDF(29292), AOM_ICDF(29822), AOM_ICDF(30431),
  AOM_ICDF(30922), AOM_ICDF(31280), AOM_ICDF(31588), AOM_ICDF(31980),
  AOM_ICDF(32247), AOM_ICDF(32545), AOM_ICDF(32670), AOM_ICDF(32768)
};
#endif
