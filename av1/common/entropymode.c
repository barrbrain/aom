...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(2361),  AOM_ICDF(5530),  AOM_ICDF(8714),  AOM_ICDF(15256),
  AOM_ICDF(22093), AOM_ICDF(23669), AOM_ICDF(25705), AOM_ICDF(26934),
  AOM_ICDF(27895), AOM_ICDF(28881), AOM_ICDF(31152), AOM_ICDF(31550),
  AOM_ICDF(32187), AOM_ICDF(32574), AOM_ICDF(32768), 0
};
#endif
