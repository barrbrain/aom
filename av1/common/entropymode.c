...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(21011), AOM_ICDF(24355), AOM_ICDF(25898), AOM_ICDF(27341),
  AOM_ICDF(28376), AOM_ICDF(29268), AOM_ICDF(29877), AOM_ICDF(30407),
  AOM_ICDF(30908), AOM_ICDF(31314), AOM_ICDF(31713), AOM_ICDF(32065),
  AOM_ICDF(32329), AOM_ICDF(32543), AOM_ICDF(32669), AOM_ICDF(32768)
};
#endif
