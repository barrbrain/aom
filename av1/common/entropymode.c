...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(16079), AOM_ICDF(16514), AOM_ICDF(21755), AOM_ICDF(21950),
  AOM_ICDF(23844), AOM_ICDF(26320), AOM_ICDF(27090), AOM_ICDF(27303),
  AOM_ICDF(27712), AOM_ICDF(29365), AOM_ICDF(29549), AOM_ICDF(30591),
  AOM_ICDF(31867), AOM_ICDF(32265), AOM_ICDF(32660), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(6887), AOM_ICDF(10371), AOM_ICDF(14789), AOM_ICDF(16259),
  AOM_ICDF(17600), AOM_ICDF(19601), AOM_ICDF(20314), AOM_ICDF(22433),
  AOM_ICDF(23389), AOM_ICDF(25910), AOM_ICDF(26444), AOM_ICDF(28510),
  AOM_ICDF(28949), AOM_ICDF(30253), AOM_ICDF(31567), AOM_ICDF(32768),
};
#endif
