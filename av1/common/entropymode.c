...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18533), AOM_ICDF(19973), AOM_ICDF(21119), AOM_ICDF(21324),
  AOM_ICDF(21401), AOM_ICDF(26674), AOM_ICDF(28060), AOM_ICDF(28129),
  AOM_ICDF(28199), AOM_ICDF(28436), AOM_ICDF(28940), AOM_ICDF(30880),
...
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(627),   AOM_ICDF(2462),  AOM_ICDF(2827),  AOM_ICDF(3989),
  AOM_ICDF(5770),  AOM_ICDF(7788),  AOM_ICDF(8628),  AOM_ICDF(15242),
  AOM_ICDF(16442), AOM_ICDF(23032), AOM_ICDF(24103), AOM_ICDF(28145),
  AOM_ICDF(28817), AOM_ICDF(31114), AOM_ICDF(32017), AOM_ICDF(32768)
};
#endif
