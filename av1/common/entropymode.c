...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(25378), AOM_ICDF(25556), AOM_ICDF(25981), AOM_ICDF(26181),
        AOM_ICDF(26344), AOM_ICDF(26504), AOM_ICDF(26691), AOM_ICDF(26970),
        AOM_ICDF(27144), AOM_ICDF(27951), AOM_ICDF(28513), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13449), AOM_ICDF(19094), AOM_ICDF(19216), AOM_ICDF(19347),
        AOM_ICDF(19504), AOM_ICDF(19942), AOM_ICDF(20038), AOM_ICDF(20133),
        AOM_ICDF(20556), AOM_ICDF(21432), AOM_ICDF(25103), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14597), AOM_ICDF(14652), AOM_ICDF(20769), AOM_ICDF(20868),
        AOM_ICDF(20985), AOM_ICDF(21058), AOM_ICDF(21403), AOM_ICDF(21826),
        AOM_ICDF(21895), AOM_ICDF(22650), AOM_ICDF(25480), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15863), AOM_ICDF(16053), AOM_ICDF(16232), AOM_ICDF(21996),
        AOM_ICDF(22190), AOM_ICDF(22403), AOM_ICDF(22597), AOM_ICDF(23613),
        AOM_ICDF(24403), AOM_ICDF(26065), AOM_ICDF(26499), AOM_ICDF(32768), 0 },
      { AOM_ICDF(16044), AOM_ICDF(16175), AOM_ICDF(16547), AOM_ICDF(16755),
        AOM_ICDF(24517), AOM_ICDF(25496), AOM_ICDF(26566), AOM_ICDF(26779),
        AOM_ICDF(27008), AOM_ICDF(27903), AOM_ICDF(28219), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13484), AOM_ICDF(14259), AOM_ICDF(14608), AOM_ICDF(14778),
        AOM_ICDF(16087), AOM_ICDF(24995), AOM_ICDF(25217), AOM_ICDF(25353),
        AOM_ICDF(25555), AOM_ICDF(26383), AOM_ICDF(26503), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15702), AOM_ICDF(15782), AOM_ICDF(16764), AOM_ICDF(16931),
        AOM_ICDF(17904), AOM_ICDF(18093), AOM_ICDF(24814), AOM_ICDF(24986),
        AOM_ICDF(25137), AOM_ICDF(26087), AOM_ICDF(26313), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15618), AOM_ICDF(15706), AOM_ICDF(16220), AOM_ICDF(16767),
        AOM_ICDF(16927), AOM_ICDF(17034), AOM_ICDF(17236), AOM_ICDF(23246),
        AOM_ICDF(23400), AOM_ICDF(25125), AOM_ICDF(25473), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14755), AOM_ICDF(15223), AOM_ICDF(15368), AOM_ICDF(16161),
        AOM_ICDF(16361), AOM_ICDF(16626), AOM_ICDF(16774), AOM_ICDF(17110),
        AOM_ICDF(22765), AOM_ICDF(24177), AOM_ICDF(24953), AOM_ICDF(32768), 0 },
      { AOM_ICDF(19428), AOM_ICDF(19647), AOM_ICDF(20058), AOM_ICDF(20268),
        AOM_ICDF(20507), AOM_ICDF(20710), AOM_ICDF(20978), AOM_ICDF(21348),
        AOM_ICDF(21603), AOM_ICDF(23637), AOM_ICDF(25127), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14024), AOM_ICDF(14917), AOM_ICDF(16308), AOM_ICDF(16477),
        AOM_ICDF(16620), AOM_ICDF(16782), AOM_ICDF(16926), AOM_ICDF(17160),
        AOM_ICDF(17339), AOM_ICDF(18234), AOM_ICDF(26107), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(16245), AOM_ICDF(16750), AOM_ICDF(22087), AOM_ICDF(22294),
  AOM_ICDF(24314), AOM_ICDF(26713), AOM_ICDF(27426), AOM_ICDF(27696),
  AOM_ICDF(28081), AOM_ICDF(29428), AOM_ICDF(29633), AOM_ICDF(30710),
  AOM_ICDF(31909), AOM_ICDF(32288), AOM_ICDF(32664), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(6735), AOM_ICDF(10540), AOM_ICDF(14765), AOM_ICDF(16372),
  AOM_ICDF(17636), AOM_ICDF(19621), AOM_ICDF(20349), AOM_ICDF(22512),
  AOM_ICDF(23449), AOM_ICDF(25954), AOM_ICDF(26485), AOM_ICDF(28573),
  AOM_ICDF(28996), AOM_ICDF(30277), AOM_ICDF(31568), AOM_ICDF(32768),
};
#endif
