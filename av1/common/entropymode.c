...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18529), AOM_ICDF(19968), AOM_ICDF(21116), AOM_ICDF(21321),
  AOM_ICDF(21398), AOM_ICDF(26668), AOM_ICDF(28056), AOM_ICDF(28125),
  AOM_ICDF(28195), AOM_ICDF(28433), AOM_ICDF(28936), AOM_ICDF(30878),
  AOM_ICDF(31232), AOM_ICDF(32267), AOM_ICDF(32514), AOM_ICDF(32768)
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(633),   AOM_ICDF(2408),  AOM_ICDF(2773),  AOM_ICDF(3951),
  AOM_ICDF(5726),  AOM_ICDF(7725),  AOM_ICDF(8562),  AOM_ICDF(15608),
  AOM_ICDF(16806), AOM_ICDF(23004), AOM_ICDF(24072), AOM_ICDF(28161),
  AOM_ICDF(28831), AOM_ICDF(31117), AOM_ICDF(32017), AOM_ICDF(32768)
};
#endif
