...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18537), AOM_ICDF(19920), AOM_ICDF(21048), AOM_ICDF(21278),
  AOM_ICDF(21364), AOM_ICDF(26606), AOM_ICDF(28030), AOM_ICDF(28116),
  AOM_ICDF(28209), AOM_ICDF(28458), AOM_ICDF(28976), AOM_ICDF(30906),
  AOM_ICDF(31270), AOM_ICDF(32302), AOM_ICDF(32531), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(670),   AOM_ICDF(2616),  AOM_ICDF(2971),  AOM_ICDF(4139),
  AOM_ICDF(5869),  AOM_ICDF(8210),  AOM_ICDF(9050),  AOM_ICDF(15252),
  AOM_ICDF(16420), AOM_ICDF(22910), AOM_ICDF(23950), AOM_ICDF(28152),
  AOM_ICDF(28833), AOM_ICDF(31083), AOM_ICDF(31993), AOM_ICDF(32768)
};
#endif
