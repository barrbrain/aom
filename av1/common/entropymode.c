...
static const aom_cdf_prob default_cfl_sign_cdf[CDF_SIZE(CFL_JOINT_SIGNS)] = {
  AOM_ICDF(3229),  AOM_ICDF(4703),  AOM_ICDF(11547),  AOM_ICDF(15168),
  AOM_ICDF(24688), AOM_ICDF(26540), AOM_ICDF(32126), AOM_ICDF(32768)
};
...
static const aom_cdf_prob
    default_cfl_alpha_cdf[CFL_JOINT_SIGNS][CFL_PRED_PLANES]
      ...
      { { 0 },
        { AOM_ICDF(14067), AOM_ICDF(22443), AOM_ICDF(26530), AOM_ICDF(29028),
          AOM_ICDF(30440), AOM_ICDF(31160), AOM_ICDF(31578), AOM_ICDF(31989),
          AOM_ICDF(32143), AOM_ICDF(32286), AOM_ICDF(32418), AOM_ICDF(32474),
          AOM_ICDF(32556), AOM_ICDF(32610), AOM_ICDF(32678), AOM_ICDF(32768) } },
      { { 0 },
        { AOM_ICDF(14004), AOM_ICDF(22489), AOM_ICDF(26931), AOM_ICDF(29441),
          AOM_ICDF(30827), AOM_ICDF(31516), AOM_ICDF(31925), AOM_ICDF(32294),
          AOM_ICDF(32449), AOM_ICDF(32596), AOM_ICDF(32682), AOM_ICDF(32715),
          AOM_ICDF(32737), AOM_ICDF(32746), AOM_ICDF(32756), AOM_ICDF(32768) } },
      { { AOM_ICDF(14564), AOM_ICDF(23258), AOM_ICDF(27384), AOM_ICDF(29833),
          AOM_ICDF(31086), AOM_ICDF(31690), AOM_ICDF(32027), AOM_ICDF(32315),
          AOM_ICDF(32429), AOM_ICDF(32529), AOM_ICDF(32599), AOM_ICDF(32636),
          AOM_ICDF(32674), AOM_ICDF(32698), AOM_ICDF(32727), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(11787), AOM_ICDF(19837), AOM_ICDF(24472), AOM_ICDF(27412),
          AOM_ICDF(29193), AOM_ICDF(30270), AOM_ICDF(30935), AOM_ICDF(31517),
          AOM_ICDF(31822), AOM_ICDF(32045), AOM_ICDF(32185), AOM_ICDF(32306),
          AOM_ICDF(32380), AOM_ICDF(32460), AOM_ICDF(32550), AOM_ICDF(32768) },
        { AOM_ICDF(15520), AOM_ICDF(23504), AOM_ICDF(27193), AOM_ICDF(29272),
          AOM_ICDF(30475), AOM_ICDF(31095), AOM_ICDF(31513), AOM_ICDF(31878),
          AOM_ICDF(32074), AOM_ICDF(32224), AOM_ICDF(32341), AOM_ICDF(32441),
          AOM_ICDF(32504), AOM_ICDF(32548), AOM_ICDF(32622), AOM_ICDF(32768) } },
      { { AOM_ICDF(10925), AOM_ICDF(19453), AOM_ICDF(24559), AOM_ICDF(27664),
          AOM_ICDF(29460), AOM_ICDF(30510), AOM_ICDF(31176), AOM_ICDF(31728),
          AOM_ICDF(31992), AOM_ICDF(32188), AOM_ICDF(32322), AOM_ICDF(32426),
          AOM_ICDF(32496), AOM_ICDF(32558), AOM_ICDF(32637), AOM_ICDF(32768) },
        { AOM_ICDF(9248),  AOM_ICDF(17409), AOM_ICDF(22816), AOM_ICDF(26349),
          AOM_ICDF(28437), AOM_ICDF(29685), AOM_ICDF(30537), AOM_ICDF(31350),
          AOM_ICDF(31825), AOM_ICDF(32252), AOM_ICDF(32481), AOM_ICDF(32588),
          AOM_ICDF(32640), AOM_ICDF(32675), AOM_ICDF(32711), AOM_ICDF(32768) } },
      { { AOM_ICDF(9099),  AOM_ICDF(16790), AOM_ICDF(22296), AOM_ICDF(26677),
          AOM_ICDF(29550), AOM_ICDF(31110), AOM_ICDF(31911), AOM_ICDF(32451),
          AOM_ICDF(32597), AOM_ICDF(32676), AOM_ICDF(32719), AOM_ICDF(32735),
          AOM_ICDF(32751), AOM_ICDF(32757), AOM_ICDF(32762), AOM_ICDF(32768) },
        { 0 } },
      { { AOM_ICDF(5327),  AOM_ICDF(13045), AOM_ICDF(19415), AOM_ICDF(24160),
          AOM_ICDF(27338), AOM_ICDF(29298), AOM_ICDF(30590), AOM_ICDF(31746),
          AOM_ICDF(32257), AOM_ICDF(32473), AOM_ICDF(32579), AOM_ICDF(32639),
          AOM_ICDF(32673), AOM_ICDF(32697), AOM_ICDF(32721), AOM_ICDF(32768) },
        { AOM_ICDF(11630), AOM_ICDF(20250), AOM_ICDF(25012), AOM_ICDF(27885),
          AOM_ICDF(29542), AOM_ICDF(30508), AOM_ICDF(31123), AOM_ICDF(31688),
          AOM_ICDF(31943), AOM_ICDF(32136), AOM_ICDF(32278), AOM_ICDF(32390),
          AOM_ICDF(32469), AOM_ICDF(32533), AOM_ICDF(32613), AOM_ICDF(32768) } },
      { { AOM_ICDF(7015),  AOM_ICDF(13395), AOM_ICDF(18844), AOM_ICDF(23626),
          AOM_ICDF(27175), AOM_ICDF(29533), AOM_ICDF(31009), AOM_ICDF(32094),
          AOM_ICDF(32473), AOM_ICDF(32637), AOM_ICDF(32697), AOM_ICDF(32725),
          AOM_ICDF(32741), AOM_ICDF(32749), AOM_ICDF(32758), AOM_ICDF(32768) },
        { AOM_ICDF(14302), AOM_ICDF(22947), AOM_ICDF(27031), AOM_ICDF(29259),
          AOM_ICDF(30457), AOM_ICDF(31149), AOM_ICDF(31609), AOM_ICDF(32014),
          AOM_ICDF(32240), AOM_ICDF(32469), AOM_ICDF(32598), AOM_ICDF(32665),
          AOM_ICDF(32701), AOM_ICDF(32724), AOM_ICDF(32742), AOM_ICDF(32768) } },
    };
#endif
