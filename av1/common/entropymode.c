...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(18569), AOM_ICDF(20040), AOM_ICDF(21170), AOM_ICDF(21398),
  AOM_ICDF(21485), AOM_ICDF(26726), AOM_ICDF(28074), AOM_ICDF(28162),
  AOM_ICDF(28256), AOM_ICDF(28507), AOM_ICDF(29034), AOM_ICDF(30890),
  AOM_ICDF(31254), AOM_ICDF(32301), AOM_ICDF(32530), AOM_ICDF(32768)
};
static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(675),   AOM_ICDF(2626),  AOM_ICDF(2980),  AOM_ICDF(4115),
  AOM_ICDF(5849),  AOM_ICDF(8373),  AOM_ICDF(9212),  AOM_ICDF(15291),
  AOM_ICDF(16460), AOM_ICDF(22800), AOM_ICDF(23838), AOM_ICDF(28151),
  AOM_ICDF(28828), AOM_ICDF(31065), AOM_ICDF(31957), AOM_ICDF(32768)
};
#endif
