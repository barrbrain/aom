...
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(UV_INTRA_MODES)] = {
      { AOM_ICDF(22746), AOM_ICDF(22919), AOM_ICDF(23317), AOM_ICDF(23503),
        AOM_ICDF(23657), AOM_ICDF(23804), AOM_ICDF(23980), AOM_ICDF(24254),
        AOM_ICDF(24420), AOM_ICDF(25133), AOM_ICDF(25628), AOM_ICDF(32768), 0 },
      { AOM_ICDF(9780), AOM_ICDF(15061), AOM_ICDF(15177), AOM_ICDF(15300),
        AOM_ICDF(15450), AOM_ICDF(15866), AOM_ICDF(15958), AOM_ICDF(16051),
        AOM_ICDF(16458), AOM_ICDF(17245), AOM_ICDF(20393), AOM_ICDF(32768), 0 },
      { AOM_ICDF(10886), AOM_ICDF(10940), AOM_ICDF(16698), AOM_ICDF(16793),
        AOM_ICDF(16903), AOM_ICDF(16973), AOM_ICDF(17300), AOM_ICDF(17709),
        AOM_ICDF(17777), AOM_ICDF(18445), AOM_ICDF(20861), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13655), AOM_ICDF(13842), AOM_ICDF(14023), AOM_ICDF(19581),
        AOM_ICDF(19771), AOM_ICDF(19976), AOM_ICDF(20162), AOM_ICDF(21147),
        AOM_ICDF(21922), AOM_ICDF(23462), AOM_ICDF(23869), AOM_ICDF(32768), 0 },
      { AOM_ICDF(14346), AOM_ICDF(14476), AOM_ICDF(14835), AOM_ICDF(15040),
        AOM_ICDF(22422), AOM_ICDF(23361), AOM_ICDF(24404), AOM_ICDF(24622),
        AOM_ICDF(24843), AOM_ICDF(25702), AOM_ICDF(26006), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11640), AOM_ICDF(12406), AOM_ICDF(12740), AOM_ICDF(12905),
        AOM_ICDF(14166), AOM_ICDF(22658), AOM_ICDF(22873), AOM_ICDF(23009),
        AOM_ICDF(23204), AOM_ICDF(23992), AOM_ICDF(24110), AOM_ICDF(32768), 0 },
      { AOM_ICDF(13214), AOM_ICDF(13292), AOM_ICDF(14257), AOM_ICDF(14419),
        AOM_ICDF(15353), AOM_ICDF(15535), AOM_ICDF(21859), AOM_ICDF(22025),
        AOM_ICDF(22172), AOM_ICDF(23049), AOM_ICDF(23266), AOM_ICDF(32768), 0 },
      { AOM_ICDF(12345), AOM_ICDF(12429), AOM_ICDF(12936), AOM_ICDF(13452),
        AOM_ICDF(13603), AOM_ICDF(13709), AOM_ICDF(13900), AOM_ICDF(19643),
        AOM_ICDF(19792), AOM_ICDF(21333), AOM_ICDF(21660), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11746), AOM_ICDF(12207), AOM_ICDF(12348), AOM_ICDF(13097),
        AOM_ICDF(13288), AOM_ICDF(13542), AOM_ICDF(13685), AOM_ICDF(14012),
        AOM_ICDF(19353), AOM_ICDF(20636), AOM_ICDF(21343), AOM_ICDF(32768), 0 },
      { AOM_ICDF(15040), AOM_ICDF(15250), AOM_ICDF(15632), AOM_ICDF(15829),
        AOM_ICDF(16052), AOM_ICDF(16241), AOM_ICDF(16495), AOM_ICDF(16854),
        AOM_ICDF(17090), AOM_ICDF(18842), AOM_ICDF(20104), AOM_ICDF(32768), 0 },
      { AOM_ICDF(11602), AOM_ICDF(12471), AOM_ICDF(13823), AOM_ICDF(13983),
        AOM_ICDF(14122), AOM_ICDF(14279), AOM_ICDF(14417), AOM_ICDF(14641),
        AOM_ICDF(14815), AOM_ICDF(15643), AOM_ICDF(23008), AOM_ICDF(32768), 0 },
    };
#else
static const aom_cdf_prob
    default_uv_mode_cdf[INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
static const aom_cdf_prob default_cfl_uvec_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(19216), AOM_ICDF(19522), AOM_ICDF(24581), AOM_ICDF(24723),
  AOM_ICDF(26878), AOM_ICDF(28340), AOM_ICDF(28796), AOM_ICDF(28967),
  AOM_ICDF(29222), AOM_ICDF(30032), AOM_ICDF(30167), AOM_ICDF(31343),
  AOM_ICDF(32215), AOM_ICDF(32453), AOM_ICDF(32692), AOM_ICDF(32768),
};

static const aom_cdf_prob default_cfl_mag_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(8871), AOM_ICDF(11527), AOM_ICDF(14553), AOM_ICDF(15849),
  AOM_ICDF(17551), AOM_ICDF(18872), AOM_ICDF(20068), AOM_ICDF(23069),
  AOM_ICDF(24180), AOM_ICDF(27054), AOM_ICDF(27741), AOM_ICDF(29432),
  AOM_ICDF(30301), AOM_ICDF(31133), AOM_ICDF(32006), AOM_ICDF(32768),
};
#endif
