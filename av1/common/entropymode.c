...
static const aom_cdf_prob default_cfl_alpha_cdf[CDF_SIZE(CFL_ALPHABET_SIZE)] = {
  AOM_ICDF(20633), AOM_ICDF(24066), AOM_ICDF(25644), AOM_ICDF(27138),
  AOM_ICDF(28205), AOM_ICDF(29117), AOM_ICDF(29773), AOM_ICDF(30321),
  AOM_ICDF(30845), AOM_ICDF(31274), AOM_ICDF(31689), AOM_ICDF(32046),
  AOM_ICDF(32321), AOM_ICDF(32539), AOM_ICDF(32666), AOM_ICDF(32768)
};
#endif
